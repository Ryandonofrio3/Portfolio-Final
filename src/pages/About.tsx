        ...
        <div id="about" className="p-5 flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-10 bg-blender">
            ...
            <div className="flex-1 space-y-5">
                ...
                <p className="text-3xl text-white">
                    I'm Ryan D'Onofrio, a third year PhD student who found my true passion in software development. We are at a critical juncture point in new technologies and I believe I can make an impact.
                </p>
                <p className="text-3xl text-white">
