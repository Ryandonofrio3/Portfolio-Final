...
import LearningTree from '../components/tree'
...
const Contact: React.FC = () => {
    ...
    return (
        <div id="contact" className="p-5 mt-20 bg-blender text-white flex md:flex-row">
            <div className="w-full md:w-1/2 space-y-5">
                <h2 className="text-2xl mb-5 font-bold"><FaEnvelope className="inline-block mr-2 mb-1" />Get in Touch</h2>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <div>
                        <label htmlFor="name" className="block w-full mb-2 text-2xl">Name</label>
                        <input
                            id="name"
                            type="text"
                    ...
                    <div>
                        <label htmlFor="message" className="block w-full mb-2 text-2xl">Message</label>
                        <textarea
                            id="message"
